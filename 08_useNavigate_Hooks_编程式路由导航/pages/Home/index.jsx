...
import { Navigate, Link, Outlet, useMatch, useNavigate } from 'react-router-dom'
...
export default function Home() {
  ...
  // useMatch钩子的使用---返回的是当前在地址栏中的path和参数中给定的路由之间的对应关系
  console.log(useMatch('/home/news/:id/:title/:content'))
          ...
          <div className="panel-body">
            ...
            {newsList.map((item) => {
              return (
                <ul key={item.id}>
                  <li>
                    <Link to={`/home/news/${item.id}/${item.title}/${item.content}`}>{item.title}</Link><br />
