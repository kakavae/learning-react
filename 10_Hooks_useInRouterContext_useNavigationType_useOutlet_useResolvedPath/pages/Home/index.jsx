...
import { Navigate, Link, Outlet, useNavigate, useOutlet, useResolvedPath } from 'react-router-dom'
...
export default function Home() {
  ...
  // 呈现当前被渲染的嵌套组件
  console.log('呈现当前被渲染的嵌套组件', useOutlet())
  // 解析给定路径的path,search,hash
  console.log('解析给定的路径中含有的参数', useResolvedPath('/home/news/?id=1&title=新闻1&content=好新闻'))
